...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            if (res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Login realizado com sucesso!");
                router.push('/');
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.error || "Erro ao fazer login. Verifique suas credenciais.");
            }
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Ocorreu um erro no servidor.");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_b25fe6e2._.js.map